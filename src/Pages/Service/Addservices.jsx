...
const Addservices = () => {
  ...
  const handleAddService = async (e) => {
    ...
    try {
      ...
      // alert("Service added successfully!");t
  ...
  return (
    <div className={`min-h-screen flex items-center justify-center px-4 py-10 ${day ? "bg-black" : "bg-gray-100"}`}>
      <Helmet>
        <title>Add Service - Service Sharing</title>
      </Helmet>

      <div className={`w-full max-w-md p-8 rounded-lg shadow-md ${day ? "bg-gray-800 text-white" : "bg-white"}`}>
        ...
        <form onSubmit={handleAddService} className="space-y-4">
          {[
            ...
            <div key={name}>
              ...
              <input
                ...
                required
                className={`w-full px-3 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-primary ${day
          ...
          <div>
            ...
            <textarea
              ...
              required
              className={`w-full px-3 py-2 border rounded-md resize-none focus:outline-none focus:ring-2 focus:ring-primary ${day
                ? "bg-gray-700 border-gray-600 text-white"
                : "bg-white border-gray-300 text-gray-800"
                }`}
            ></textarea>
          ...
          <button
            ...
            className={`w-full py-2 rounded-md font-semibold transition-colors duration-200 ${day
